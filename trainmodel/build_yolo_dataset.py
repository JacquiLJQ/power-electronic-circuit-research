...
#     Flatten samples into these folders with consistent names.
#     """
...
#         sd = samples[sidx]
#         split = "val" if sidx in val_set else "train"
...
#         dst_img = (img_val if split == "val" else img_train) / f"{stem}.png"
#         dst_lab = (lab_val if split == "val" else lab_train) / f"{stem}.txt"

#         shutil.copy2(src_img, dst_img)
#         shutil.copy2(src_lab, dst_lab)

#     print(f"[YOLO] wrote dataset to: {yolo_root}")
#     print(f"[YOLO] train={len(samples)-n_val}, val={n_val}")
...
#     If class_names is None, we won't write yaml.
#     """
#     if not class_names:
#         return

#     yaml_path = yolo_root / "data.yaml"
#     # Ultralytics expects paths relative or absolute; we keep relative
#     content = [
...
#         description="Run gen.py -> cleanup -> build YOLO folder structure"
#     )
...
#     copy_to_yolo_structure(samples, yolo_root, args.val_ratio, args.seed)
...
#         write_data_yaml(yolo_root, class_names)
