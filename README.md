...
```
yolo train model=yolo11n.pt data=synthetic_schemdraw__dataset_no_wire/data.yaml imgsz=1280 epochs=100 batch=4 device=0 project="v2" name="1.1" workers=8 hsv_v=0 hsv_s=0 hsv_h=0                    
